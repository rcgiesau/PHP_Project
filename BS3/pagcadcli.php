...
<div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" onkeyup="mascara( this, mtel );" maxlength="14" placeholder="Telefone" name="fone" id="fone">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Celular</label>
                                                <input type="text" class="form-control" placeholder="Celular" onkeyup="mascara( this, mtel );" maxlength="15" name="celu" id="celu" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Endereco" name="ende" id="ende" >
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Bairro</label>
                                                <input type="text" class="form-control" placeholder="Bairro" name="bair" id="bair" >
                                            </div>
                                        </div>
                                    </div>                 
   ...
   <!-- <script src="assets/js/jquery.3.2.1.min.js" type="text/javascript"></script>-->
    ...
    <script type="text/javascript" src="js/fAjaxCliente.js"></script>
